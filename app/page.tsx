...
export default function HomePage() {
  ...
  const [experienceSection, experienceRef] = useState<Seccion | null>(null)
  const [locationSection, locationRef] = useState<Seccion | null>(null)
  ...
  useEffect(() => {
    async function loadContent() {
      try {
        const [banners, experience, location] = await Promise.all([
          getBannersForPage("inicio"),
          getSeccionByClave("home-experience"),
          getSeccionByClave("home-location"),
        ])
        
        setMainBanner(banners[0] || null)
  ...
  // Usar datos de la BD o defaults si no están disponibles
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300 flex-wrap">
            ...
            >
              {banner.boton_texto || "Ver carta de cafetería"}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className={`text-center mb-16 transition-all duration-700 ${experienceSectionInView.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="font-[family-name:var(--font-dm-serif)] text-3xl md:text-5xl text-primary mt-2">
              {experienceSection?.titulo || "Un lugar para cada momento"}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 transition-all duration-700 delay-200 ${locationSectionInView.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              <div>
                ...
                <h2 className="font-[family-name:var(--font-dm-serif)] text-3xl md:text-5xl text-primary mt-2">
                  {locationSection?.titulo || "Encontranos en Ciudad Jardín"}
                </h2>
              </div>
