      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Map */}
            <div className={`aspect-video lg:aspect-square rounded-2xl overflow-hidden shadow-lg transition-all duration-700 ${locationSection.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <iframe
